...
| Market witness governance: `docs/product/scenarios/market_witness_governance.md` and `src/game/scenarios/marketWitnessLedger.js` | Internal scenario-governance artifact / implementation scaffold | Defines how historical market material must become attributed, transformed, static witnesses before it can influence `Market Signal Scout` clues, hidden pressure, traces, or hindsight cards. | The ledger module is bundled source but not yet wired into the active scene; no live market API or raw historical data is bundled. |
| Binance Public Data: https://github.com/binance/binance-public-data and https://data.binance.vision/ | Selected PB-013 market-data fixture source | Planned source for small bundled static Binance spot `BTCUSDT` kline-derived fixtures. The Binance Public Data README describes downloadable daily/monthly public market data files, kline fields, and lists the licence as MIT. Pocket Bot must scope this as Binance BTCUSDT venue history, not a global Bitcoin index. | Planned bundled transformed static fixture under `src/game/scenarios/data/`; no live Binance API/runtime fetch is planned. |
| Cboe Bitcoin futures launch announcement: https://ir.cboe.com/news/news-details/2017/Cboe-Plans-December-10-Launch-of-Bitcoin-Futures-Trading-12-04-2017/default.aspx | Historical event headline witness | Candidate source headline/title for the Golden Signal `Futures Gate` event surface. The exact source title may appear in a witness card, paired with fictional mechanics connector text. | Documentation/source witness only until transformed into a static scenario fixture; no exchange/trading integration. |
| CME Bitcoin futures launch announcement: https://www.cmegroup.com/media-room/press-releases/2017/12/01/cme_group_self-certifiesbitcoinfuturestolaunchdec18.html | Historical event headline witness | Candidate source headline/title for the Golden Signal `Futures Gate` event surface and event-pressure clue. | Documentation/source witness only until transformed into a static scenario fixture; no exchange/trading integration. |
| CFTC bitcoin products self-certification statement: https://www.cftc.gov/PressRoom/PressReleases/7654-17 | Historical event headline witness / regulatory context | Candidate source title/context for the Golden Signal event surface, supporting the in-game idea that a regulated futures gate opens around the 2017 signal window. | Documentation/source witness only until transformed into a static scenario fixture; no legal, investment, or trading claim. |
